...
the target website. You must make your program generate a QR code that takes someone to your GitHub homepage i.e. https://github.com/Anneryshc<replace mine with yours>
...
![My qr](./imagenes/QR.png)

2.  Add an image of viewing the log of successfully creating the QR code below.
 ![My loggins](./imagenes/loggingsforQR.png)
